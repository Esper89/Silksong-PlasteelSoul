...
You can access all Steel Soul-exclusive game content through various means. Specifically, in
non-Steel Soul mode,
...
`BepInEx/config/Esper89.PlasteelSoul.cfg` or in-game using Configuration Manager (if you have it
installed) by pressing the **F1** key.
...
Plasteel Soul's source code can be found in its
[GitHub repository](https://github.com/Esper89/Silksong-PlasteelSoul).
